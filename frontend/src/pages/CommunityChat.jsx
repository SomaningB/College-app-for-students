...
export default function CommunityChat() {
  ...
  return (
    <div style={{ display: 'flex', gap: 0, height: 'calc(100vh - 80px)', margin: -24 }}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
        <div style={{ padding: '12px 20px', borderBottom: '1px solid var(--border)', background: 'var(--bg-secondary)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexShrink: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <Link to="/app/communities" style={{ color: 'var(--text-muted)', display: 'flex' }}>
              <FiArrowLeft size={18} />
            </Link>
            <div>
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: 20 }} className="scrollbar-custom">
          {messages.length === 0 ? (
