...
import { FiArrowRight, FiBook, FiMessageSquare, FiCpu, FiUsers } from 'react-icons/fi'
          ...
          <div style={{ maxWidth: 900, textAlign: 'center' }}>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.6 }}
              ...
              {[
                ...
                { icon: FiMessageSquare, label: 'Real-time Chat', desc: 'Connect with classmates & friends' },
